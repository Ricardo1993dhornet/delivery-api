...
export function NewOrderForm({
  ...
  return (
    ...
    >
      <h3 style={{ marginTop: 0 }}>➕ Criar Pedido (formato completo)</h3>
      ...
      <div style={{ marginTop: 10, fontSize: 12, opacity: 0.7 }}>
        Este formulário cria pedidos no mesmo formato do JSON original (com store_id, payments, delivery_address, etc).
      </div>
    </div>
  );
}
